...
namespace N400.Native.Data.Internals
{
    ...
    internal static class SqlCli
    {
        ...
        [DllImport("libdb400")]
        internal static extern SqlStatusReturnCode SQLOverrideCCSID400(int env);
        [DllImport("libdb400")]
        ...
        [DllImport("libdb400")]
        internal static extern SqlStatusReturnCode SQLDescribeCol(int stmt, short col, StringBuilder name, short nameLen, out short nameOutLen, out short type, out int precision, out short scale, out short nullable);
        // Very overloadable
        [DllImport("libdb400")]
        ...
        [DllImport("libdb400")]
        internal static extern SqlStatusReturnCode SQLGetCol(int stmt, short col, short type, IntPtr value, int valueLen, out int outLen);
        [DllImport("libdb400")]
        internal static extern SqlStatusReturnCode SQLGetCol(int stmt, short col, short type, StringBuilder value, int valueLen, out int outLen);
        [DllImport("libdb400")]
